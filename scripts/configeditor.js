...
function resetCommitOptions(){
    ...
    $("#comOpConnectivity").parent().parent().css({'display':'none'});
    $("#comOpEnaInterface").attr("checked",false);
    $("#comOpEnaInterface").parent().parent().css({'display':'none'});
    $("#comOpLinkSanity").attr("checked",false);
    $("#comOpLinkSanity").parent().parent().css({'display':'none'});
...
//2nd Table of Device Sanity
		...
		devSanityStat+="<td>"+devicesArr[i].Model+"</td>";
...
function connSanityData(){
	...
	for(var i = 0; i < devicesArr.length; i++){
		...
		connStat+="<td>Init</td>";
		connStat+="<td>Waiting..</td>";
		connStat+="<td>Waiting..</td>";
		connStat+="<td>Waiting..</td>";
		connStat+="</tr>";
//2nd Table of Device Sanity
		connSanityStat+="<tr>";
		connSanityStat+="<td>"+devicesArr[i].HostName+"</td>";
		connSanityStat+="<td>"+devicesArr[i].ManagementIp+"</td>";
		connSanityStat+="<td>"+devicesArr[i].ConsoleIp+"</td>";
		connSanityStat+="<td>"+devicesArr[i].Manufacturer+"</td>";
		connSanityStat+="<td>"+devicesArr[i].Model+"</td>";
		connSanityStat+="<td>Init</td>";
		connSanityStat+="<td>Waiting..</td>";
		connSanityStat+="</tr>";

	}
	$("#connSanTableStat > tbody").empty().append(connSanityStat);
	$("#connSanTableStat").table("refresh");
	$("#connSanTable > tbody").empty().append(connStat);
	$("#connSanTable").table("refresh");
...
//2nd Table of Device Sanity
		accSanityStat+="<tr>";	
		accStat+="<td>"+lowtable[i].getAttribute('TimeStamp')+"</td>";
		accStat+="<td>"+lowtable[i].getAttribute('HostName')+"</td>";
		accStat+="<td>"+lowtable[i].getAttribute('AccessType')+"</td>";
		accStat+="<td>"+lowtable[i].getAttribute('IpAddress')+"</td>";
		accStat+="<td>"+lowtable[i].getAttribute('Status1')+"</td>";
		accStat+="<td>"+lowtable[i].getAttribute('Status2')+"</td>";
		accStat+="<td>"+lowtable[i].getAttribute('Status3')+"</td>";
		accStat+="<td>"+lowtable[i].getAttribute('State')+"</td>";
		accStat+="<td>"+lowtable[i].getAttribute('Status')+"</td>";
		accSanityStat+="</tr>";
